# Direct Structural Analogy

Purpose: Apply a solution from one domain to a structurally similar problem in another.

Status: empty

Tags:

Pattern class: 10 Analogical and Transfer Patterns
